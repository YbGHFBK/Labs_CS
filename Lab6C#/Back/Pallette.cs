...
public static class Pallette
{
    ...
    public static readonly Color Text =             Color.FromArgb(83, 26, 26);
    public static readonly Color SecText =          Color.FromArgb(113, 113, 130);
    public static readonly Color WhiteAnalog =      Color.FromArgb(254, 251, 251);
}